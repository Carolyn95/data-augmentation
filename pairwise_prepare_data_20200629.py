...
if __name__ == '__main__':
  save_dir = 'pairwise_exprmt/data_v0'
  seril_no = '13-0'  # 13-0 | 13-1 | 13-2 | 13-3 | 13-4
  save_path = save_dir + '/' + seril_no + '/'
  save_path = Path(save_path)
  save_path.mkdir(parents=True, exist_ok=True)

  labels = np.load('processed_data/all_str_labels_balanced.npy',
                   allow_pickle=True)
  sents = np.load('processed_data/all_sents_balanced.npy', allow_pickle=True)
