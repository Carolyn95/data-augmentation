...
if __name__ == '__main__':
  ...
  num = str(4)
  train_sents_path = '20200624_exprmt_' + num + '/train_sents.npy'
  train_labels_path = '20200624_exprmt_' + num + '/train_labels.npy'
  valid_sents_path = '20200624_exprmt_' + num + '/valid_sents.npy'
  valid_labels_path = '20200624_exprmt_' + num + '/valid_labels.npy'
  ...
  vu = VanillaUSE(dr.train_sents, dr.train_labels, dr.valid_sents,
                  dr.valid_labels)
  vu.createModel()
  vu.train(filepath='serial-no/12-' + num)
  vu.consolidateResult(filepath='serial-no/12-' + num)
