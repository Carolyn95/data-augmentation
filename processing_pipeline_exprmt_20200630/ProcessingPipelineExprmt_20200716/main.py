...
if __name__ == '__main__':
  ...
  # serial_no = 'split_0/'
  # # data_dir = parent_dir + 'processed_data/'
  ...
  # train_sent = np.load(save_dir + 'train_emails.npy', allow_pickle=True)
  # valid_sent = np.load(save_dir + 'valid_emails.npy', allow_pickle=True)
  ...
  serial_no = 'split_4_rep/'
  save_dir = parent_dir + serial_no

  prefixes = ['rev_scp_', 'KW_', 'scp_']
  for prefix in prefixes:
    ...
    mdr.listToStr()
    mdr.randomizeData(input_path, prefix)
